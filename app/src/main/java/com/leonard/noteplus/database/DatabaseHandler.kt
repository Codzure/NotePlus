package com.leonard.noteplus.database
...
class DatabaseHandler(context: Context) :
     ...
     */
    fun addHappyPlace(happyPlace: NoteModel): Long {
     ...
     */
    fun updateHappyPlace(happyPlace: NoteModel): Int {
        val db = this.writableDatabase
        val contentValues = ContentValues()
        contentValues.put(KEY_TITLE, happyPlace.title) // HappyPlaceModelClass TITLE
        contentValues.put(KEY_IMAGE, happyPlace.image) // HappyPlaceModelClass IMAGE
     ...
     */
    fun deleteHappyPlace(happyPlace: NoteModel): Int {
        val db = this.writableDatabase
        // Deleting Row
