...
import com.leonard.noteplus.scanner.ui.adapters.PdfItemAdapter
import com.leonard.noteplus.scanner.ui.viewModels.HomeViewModel
...
@AndroidEntryPoint
class ScannerActivity : AppCompatActivity(), PdfItemAdapter.PdfItemListener {
...
//        startActivity(Intent(this,OpenFromGalleryActivity::class.java))
    ...
    private fun setUpRv() {
        ...
        rvPdfFiles.apply {
            ...
            addItemDecoration(DividerItemDecoration(this@ScannerActivity, LinearLayout.VERTICAL))
        }
    }
    ...
    override fun rename(item: PdfFile?) {
        ...
        renameDialogView.apply {
            ...
            btnRename.setOnClickListener {
                ...
                val fromfile = File(CameraXUtility.getOutputDirectory(this@ScannerActivity),item?.fileName.toString())
                val newFile = File(CameraXUtility.getOutputDirectory(this@ScannerActivity),"$name.pdf")
                try {
                    ...
                    Toast.makeText(this@ScannerActivity, Constants.SOMETHING_WENT_WRONG, Toast.LENGTH_SHORT).show()
                }
            }
