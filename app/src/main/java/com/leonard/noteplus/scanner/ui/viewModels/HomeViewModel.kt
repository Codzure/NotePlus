...
import com.leonard.noteplus.scanner.data.PdfFileRepository
...
class HomeViewModel @ViewModelInject constructor(
    ...
    private suspend fun copyFileInBackground(src: File?, dst: File, originalPdfFile: PdfFile?)  = withContext(
        Dispatchers.IO) {
