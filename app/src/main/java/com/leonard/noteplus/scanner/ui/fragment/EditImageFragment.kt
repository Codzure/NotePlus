package com.leonard.noteplus.scanner.ui.fragment
...
import com.leonard.noteplus.scanner.ui.CameraActivity
...
@AndroidEntryPoint
class EditImageFragment : Fragment(R.layout.fragment_edit_image), EditImageAdapter.EditImageListener {
...
//        }
    ...
    interface EditImageInteractor{
        ...
        fun onFinishFromEditImage(docList: List<com.itextpdf.text.Document>)
    }
